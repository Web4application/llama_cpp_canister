...
>- Clone the repo and it's children:
  ...
  git clone https://github.com/web4application/llama.cpp.git
  cd llama.cpp
...
Each caller of the `llama.cpp` has it's own cache folder, and has the following endpoints available to manage their prompt-cache files:
